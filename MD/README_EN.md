...
## Fine-tuning
See [LOCAL.md](./LOCAL.md) for local training guide.  
...
3. Upload the voice samples of the characters you wish to add，see [DATA.MD](./DATA_EN.MD) for detailed uploading options.
